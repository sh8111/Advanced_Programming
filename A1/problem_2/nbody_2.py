...
""" nbody2- Using alternatives to membership testing of lists
"""
...
"""
    N-body simulation - Optimization Step 2: Optimizing Membership Testing
    - Replaced list with set for membership testing
    - Maintained optimizations from step 1
"""
